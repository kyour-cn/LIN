<?php
include './main.php';
  $image = imagecreatetruecolor(70, 18);    //1>设置验证码图片大小的函数100.30
...
//7>生成随机的字母和数字
  for($i=0;$i<4;$i++){
    ...
    $fontsize = 8;
    //设置字体颜色，随机颜色
    $fontcolor = imagecolorallocate($image, rand(0,100),rand(0,100), rand(0,100));      //0-120深颜色
