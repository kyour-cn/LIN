...
$adtag="user";
    ...
    $site=query("SELECT host,diyconf FROM user where uid=?",array($yms[2]))->fetch();
    //exit($sites['uid']);
    $issite=true;
...
<div class="row">
    <div class="col-md-8 col-xs-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action ="./php/admin.php?siteupd&<?php echo $yms[2]; ?>" method="post">
                    <div class="sub-title">站点域名</div>
                    <div><input name="host" value="<?php echo $site['host'];?>" class="form-control" type="text"></div>
                    ...
                    <a href="admin-user" class="btn btn-info">返回列表</a>
                </form>
